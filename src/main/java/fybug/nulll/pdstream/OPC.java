...
class OPC {
    // 无流可读取的值
    public static volatile String CHAR_DEFAULT_DATA = "";
    public static volatile byte[] BYTE_DEFAULT_DATA = {};
    // 读取失败的值
    public static volatile String CHAR_EMPTY_DATA = null;
    public static volatile byte[] BYTE_EMPTY_DATA = null;
    // 转化过程中的缓冲区大小
